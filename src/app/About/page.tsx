        ...
        <div className="flex flex-col lg:flex-row items-center justify-center my-24 gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-[var(--darkGrey)]">
              ...
              strong focus on customer care—taking the time to understand each client&apos;s unique needs. After years of
              refining my craft, I&apos;ve developed proven methods for building high-performing websites and
